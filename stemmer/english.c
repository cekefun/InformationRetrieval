...
extern "C" {
#endif
extern int E_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * E_create_env(void);
extern void E_close_env(struct SN_env * z);
...
extern struct SN_env * E_create_env(void) { return SN_create_env(0, 2, 1); }

extern void E_close_env(struct SN_env * z) { SN_close_env(z, 0); }
