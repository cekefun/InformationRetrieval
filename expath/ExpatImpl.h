...
public:
	...
	void EnableStartElementHandler (bool fEnable = true)
	{
		assert (m_p != NULL);
		if (fEnable) {
			XML_SetStartElementHandler(m_p, StartElementHandler);
		} else {
			XML_SetStartElementHandler(m_p, NULL);
		}
	}
	...
	void EnableEndElementHandler (bool fEnable = true)
	{
		assert (m_p != NULL);
		if (fEnable) {
			XML_SetEndElementHandler(m_p, EndElementHandler);
		} else {
			XML_SetEndElementHandler(m_p, NULL);
		}
	}
	...
	void EnableCommentHandler (bool fEnable = true)
	{
		assert (m_p != NULL);
		if (fEnable) {
			XML_SetCommentHandler(m_p, CommentHandler);
		} else {
			XML_SetCommentHandler(m_p, NULL);
		}
	}
	...
	void EnableDefaultHandler (bool fEnable = true, bool fExpand = true)
	{
		...
		if (fExpand)
		{
			...
			XML_SetDefaultHandler(m_p, DefaultHandler);
		} else {
			XML_SetDefaultHandler(m_p, NULL);
		}
	}
	...
	void EnableExternalEntityRefHandler (bool fEnable = true)
	{
		...
		if (fEnable) {
			XML_SetExternalEntityRefHandler(m_p,
											reinterpret_cast<XML_ExternalEntityRefHandler>(ExternalEntityRefHandler));
		} else {
			XML_SetExternalEntityRefHandler(m_p,
											NULL);
		}
	...
	void EnableUnknownEncodingHandler (bool fEnable = true)
	{
		assert (m_p != NULL);
		if (fEnable) {
			XML_SetUnknownEncodingHandler(m_p,UnknownEncodingHandler,NULL);
		} else {
	...
	void EnableXmlDeclHandler (bool fEnable = true)
	{
		assert (m_p != NULL);
		if (fEnable) {
			XML_SetXmlDeclHandler(m_p, XmlDeclHandler);
		} else {
			XML_SetXmlDeclHandler(m_p, NULL);
		}
	}
